# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-13 13:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(choices=[('github', 'GitHub'), ('google', 'Google')], max_length=30, verbose_name='provider')),
                ('uid', models.CharField(max_length=191, verbose_name='uid')),
                ('last_login', models.DateTimeField(auto_now=True, verbose_name='last login')),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='date joined')),
                ('extra_data', django.contrib.postgres.fields.jsonb.JSONField(default=dict, verbose_name='extra data')),
